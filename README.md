...
fields, and your personal wind line stay in your browser. Each saved field shows its current
wind at a glance, so a club running more than one site can see which is flyable without
opening each one.
